...
class MediaInfoDLLWrapper
{
    private static String miFileName;
    ...
    static
    {
        ...
        try
        {
            ...
            //windows 32 bit
            if(os!=null && os.toLowerCase().startsWith("windows") && osArch.toLowerCase().equals("x86")){
                miFileName = "mediainfo_i386";
            }else{
                miFileName = "mediainfo";
            }
        }
    ...
    interface MediaInfoDLL_Internal extends Library
    {
        ...
        MediaInfoDLL_Internal INSTANCE = (MediaInfoDLL_Internal) Native.loadLibrary(miFileName, MediaInfoDLL_Internal.class, singletonMap(OPTION_FUNCTION_MAPPER, new FunctionMapper()
            {
