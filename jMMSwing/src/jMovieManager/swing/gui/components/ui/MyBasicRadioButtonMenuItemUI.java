 ...
 * @since 28.10.2012
 */
public class MyBasicRadioButtonMenuItemUI extends MyBasicMenuItemUI{
    ...
    public static ComponentUI createUI(JComponent b) {
        return new MyBasicRadioButtonMenuItemUI();
    }    
    ...
    protected void installComponents(JMenuItem menuItem){
        ...
        checkIcon = MyIconFactory.radioButtonMenuItemUnchecked;
        //arrowIcon = null;
        
//        menuItem.setIcon(MyIconFactory.radioButton_default);
//        menuItem.setDisabledIcon(MyIconFactory.radioButton_disabled);
//        menuItem.setDisabledSelectedIcon(MyIconFactory.radioButton_disabled_selected);
        menuItem.setSelectedIcon(MyIconFactory.radioButtonMenuItemChecked);
//        menuItem.setRolloverIcon(MyIconFactory.radioButton_highlight);
        menuItem.setRolloverSelectedIcon(MyIconFactory.radioButtonMenuItemChecked);
    }
//    
